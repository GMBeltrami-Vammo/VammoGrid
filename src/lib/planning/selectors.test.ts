...
describe('supplyMix', () => {
  it('sums procurement (incoming) and recovery (rate × horizon demand)', () => {
    ...
    const policies = new Map<string, SkuPolicy>([
      ['X', { skuBase: 'X', isRepairable: true, recoveryRate: 0.5, leadTimeDays: 110, leadTimeSource: 'international-default', leadTimeSeaDays: 110, leadTimeAirDays: 40, defaultModal: 'sea', leadTimeStdDays: null, abcClass: 'C', targetDoi: 60, recoveryTurnaroundDays: 14, safetyOverride: null, updatedBy: null, updatedAt: TODAY }],
    ]);
