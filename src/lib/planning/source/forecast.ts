...
// Single-SKU fast path: fetch + build ONE SkuForecast (≈90 rows, one query, well under
// the Metabase cap — no batching, no materializing the whole catalog). For the SKU
// deep-dive page, which only needs the selected SKU. Cached per sku_base.
